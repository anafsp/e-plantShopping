            ...
            <div style={styleObjUl}>
                ...
                <div> 
                    <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
                        <h1 className='cart'>
                            <span className="cart_quantity_count">{cart.reduce((acc, item) => acc + item.quantity, 0)}</span>
                        ...
                        <div className="product-list">
                            {plantsGroup.plants.map((plant, plantIndex) => (
                                <div className="product-card" key={"plant-"+plantIndex}>
                                    ...
                                    <button disabled={Object.keys(addedToCart).length > 0 && addedToCart[plant.name]}  className="product-button" onClick={() => handleAddToCart(plant)}>Add to Cart</button>
                                </div>
                            ))}
                        </div>
                    </div>
